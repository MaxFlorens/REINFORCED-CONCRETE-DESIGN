...
def CuantiasMaximasMinimas(res_concreto, res_acero, momento_ultimo):
    """
    Params:
    ...
    while True:
        ...
        if opc == '1':
            ...
            valor_prueba2 = valor_incial_para_tanteo(
                res_concreto, res_acero, momento_ultimo, Ro)
            ancho, peralte_efectivo = tanteo(
                valor_prueba=valor_prueba2, ancho=0)
            print(f"El valor aproximado con los valores tanteados es: {
                  ancho*peralte_efectivo**2}")
...
if '__main__' == __name__:
    print(f"AREA DE ACERO: {CuantiasMaximasMinimas(
